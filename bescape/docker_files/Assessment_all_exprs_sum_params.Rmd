...
```{r realBulkSCDC2,fig.width=14, fig.height=12,message=TRUE,eval=TRUE}
bulk <- readRDS(params$real)
...
```{r SCDCsimbulk,fig.width=20, fig.height=18,message=FALSE,eval=params$fulleval}
...
write.table(bulkseger.scseger$prop,file=paste0("/pstore/home/kamthont/bescape/docs/datasets/scdc/",params$studyname,"SCDC_Seger_SimBulk_exp_sum.txt"),row.names=TRUE,col.names=TRUE,quote=FALSE,sep="\t")
save(pseudo.seger,file=paste0("/pstore/home/kamthont/bescape/docs/datasets/scdc/",params$studyname,"pseudo_exp_sum.Rdata"))
...
write.table(out.frac,file=paste0("/pstore/home/kamthont/bescape/docs/datasets/music/",params$studyname,"MUSIC_SimBulk_exp_sum.txt"),sep="\t",col.names=TRUE,row.names=TRUE,quote=FALSE)
...
write.table(bulkseger.scseger_high$prop,file=paste0("/pstore/home/kamthont/bescape/docs/datasets/scdc/",params$studyname,"SCDC_Seger_SimBulk_exp_sum_highvar.txt"),row.names=TRUE,col.names=TRUE,quote=FALSE,sep="\t")
save(pseudo.seger_high,file=paste0("/pstore/home/kamthont/bescape/docs/datasets/scdc/",params$studyname,"pseudo_exp_sum_highvar.Rdata"))


```

```{r SCDCsimbulk2,fig.width=20, fig.height=18,message=FALSE,eval=TRUE}
load(file=paste0("/pstore/home/kamthont/bescape/docs/datasets/scdc/",params$studyname,"pseudo_exp_sum.Rdata"))

#Normal SCDC
result_matrix<-read.table(file=paste0("/pstore/home/kamthont/bescape/docs/datasets/scdc/",params$studyname,"SCDC_Seger_SimBulk_exp_sum.txt"),sep="\t",header=TRUE,row.names=1)
...
#SCDC with high var
result_matrix<-read.table(file=paste0("/pstore/home/kamthont/bescape/docs/datasets/scdc/",params$studyname,"SCDC_Seger_SimBulk_exp_sum_highvar.txt"),sep="\t",header=TRUE,row.names=1)
...
#Music
result_matrix<-read.table(file=paste0("/pstore/home/kamthont/bescape/docs/datasets/music/",params$studyname,"MUSIC_SimBulk_exp_sum.txt"),sep="\t",header=TRUE,row.names=1)
