...
params:
   ...
   celltypesel: !r c('pancreatic A cell','pancreatic acinar cell','pancreatic D cell','pancreatic ductal cell','type B pancreatic cell','PP cell')#cell types of interest to estimate, the exclam r needed to declare an R object
